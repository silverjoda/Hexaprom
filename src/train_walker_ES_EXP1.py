...
def f(w):
    ...
    while not done:
        ...
        l = np.tanh(np.matmul(obs, wdist.get_w('w31', w)) + wdist.get_w('b32', w))
        t2 = np.matmul(l, wdist.get_w('w32', w)) + wdist.get_w('b31', w)
        ...
        l = np.tanh(np.matmul(obs, wdist.get_w('w31', w)) + wdist.get_w('b32', w))
        t5 = np.matmul(l, wdist.get_w('w32', w)) + wdist.get_w('b31', w)
