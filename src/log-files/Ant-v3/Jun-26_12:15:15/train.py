...
def main(env_name, num_episodes, gamma, lam, kl_targ, batch_size, hid1_mult, policy_logvar, animate):
    """ Main training loop
    ...
    run_policy(env, policy, scaler, logger, episodes=5, animate=animate)
    episode = 0
